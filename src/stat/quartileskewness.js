...
/**
 * This class calculates and returns the Bowley quartile skewness of a data set.
 *
 * <br><br>
 *
 * From wikipedia: Bowley’s skew focuses on the part of the distribution that fits
 * in between the quartiles: if the right quartile is further from the median than
 * is the left quartile, then Bowley’s skew is positive; if the left quartile is
 * further from the median than the right quartile, then Bowley’s skew is negative.
 *
 * <br><br>
 *
 * <a href="https://en.wikipedia.org/wiki/Skewness#Other_measures_of_skewness" target="_blank">https://en.wikipedia.org/wiki/Skewness#Other_measures_of_skewness</a>
 *
 * <br><br>
 *
 * <b>Example:</b>
 ...
 * <br><br>
 *
 * <span style="color: purple;">var</span> quartileSkewness = <span style="color: purple;">new</span> QuartileSkewness();<br>
 * <span style="color: purple;">var</span> array = [5, 6, 2, 13, 22, 4, 9, 1, 7];<br>
 * quartileSkewness.<span style="color: Sienna;">calculate</span>(array) <span style="color: purple;">  &nbsp=>&nbsp  </span> 0.25;
 *
 * <br><br>
 *
 ...
 */
function QuartileSkewness() {
   DescriptiveStatistic.call(this);
}

QuartileSkewness.prototype = new DescriptiveStatistic();
QuartileSkewness.prototype.constructor = QuartileSkewness;

/*---------------------------------- Exports ---------------------------------*/

module.exports = new QuartileSkewness();

/*---------------------------- Calculate Function ----------------------------*/

/**
 * Calculates and returns the quartile skewness of the data set.
 * @param {number[]} data - the data set
 * @returns {number} the quartile skewness
 */
QuartileSkewness.prototype.calculate = function(data) {
   ...
   if(data.length % 2 === 0) {
      ...
      array1 = data.slice(0, index);
      array2 = data.slice(index + 1, data.length);
