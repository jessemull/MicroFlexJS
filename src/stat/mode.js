...
/**
 * This class calculates and returns the mode.
 *
 * <br><br>
 *
 * From wikipedia: the mode is the value that appears most often in a set of data.
 * The mode of a discrete probability distribution is the value x at which its
 * probability mass function takes its maximum value. In other words, it is the
 * value that is most likely to be sampled. The mode of a continuous probability
 * distribution is the value x at which its probability density function has its
 * maximum value, so the mode is at the peak.
 *
 * <br><br>
 *
 * <a href="https://en.wikipedia.org/wiki/Mode_(statistics)" target="_blank">https://en.wikipedia.org/wiki/Mode_(statistics)</a>
 *
 * <br><br>
 *
 * <b>Example:</b>
 ...
 * <br><br>
 *
 * <span style="color: purple;">var</span> mode = <span style="color: purple;">new</span> Mode();<br>
 * <span style="color: purple;">var</span> array = [1, 2, 3, 4, 5, 5, 7, 8, 9, 10];<br>
 * mode.<span style="color: Sienna;">calculate</span>(array) <span style="color: purple;">  &nbsp=>&nbsp  </span> 5;
 *
 * <br><br>
 *
...
Mode.prototype = new DescriptiveStatistic();
...
/**
 * Calculates and returns the mode of the data set.
 * @param {number[]} data - the data set
 * @returns {number[]} the mode
 */
Mode.prototype.calculate = function(data) {
