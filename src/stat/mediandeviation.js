...
/**
 * This class calculates and returns the median deviation.
 *
 * <br><br>
 *
 * From wikipedia: in statistics, the median absolute deviation (MAD) is a robust
 * measure of the variability of a univariate sample of quantitative data. It can
 * also refer to the population parameter that is estimated by the MAD calculated
 * from a sample. For a univariate data set the MAD is defined as the median of
 * the absolute deviations from the data's median.
 *
 * <br><br>
 *
 * <a href="https://en.wikipedia.org/wiki/Median_absolute_deviation" target="_blank">https://en.wikipedia.org/wiki/Median_absolute_deviation</a>
 *
 * <br><br>
 *
 * <b>Example:</b>
 ...
 * <br><br>
 *
 * <span style="color: purple;">var</span> medianDeviation = <span style="color: purple;">new</span> MedianDeviation();<br>
 * <span style="color: purple;">var</span> array = [1, 2, 3, 4, 5, 5, 7, 8, 9, 10];<br>
 * medianDeviation.<span style="color: Sienna;">calculate</span>(array) <span style="color: purple;">  &nbsp=>&nbsp  </span> 5;
 *
 * <br><br>
 *
 ...
 */
function MedianDeviation() {
   DescriptiveStatistic.call(this);
}

MedianDeviation.prototype = new DescriptiveStatistic();
MedianDeviation.prototype.constructor = MedianDeviation;

/*---------------------------------- Exports ---------------------------------*/

module.exports = new MedianDeviation();

/*---------------------------- Calculate Function ----------------------------*/

/**
 * Calculates and returns the median deviation of the data set.
 * @param {number[]} data - the data set
 * @returns {number} the median deviation
 */
MedianDeviation.prototype.calculate = function(data) {
   ...
   for(var value of data) {
      differences.push(Math.abs(value - median));
   }
