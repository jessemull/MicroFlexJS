 ...
 * <br><br>
 *
 * <b>Right Shift Logical Operation Example:</b>
 *
 * <br><br>
 *
 * <span style="color: purple;">var</span> rightShiftLogical = <span style="color: purple;">new</span> RightShiftLogical();<br>
 ...
 * rightShiftLogical.<span style="color: Sienna;">well</span>(well, bitNumber) <span style="color: purple;">  &nbsp=>&nbsp  </span> Well { base: 26, row: 0, column: 1, data: [ 1, 2, 4, 6 ] }
 *
 * <br><br>
 *
 ...
 */
function RightShiftLogical() {
   ShiftOperation.call(this);
}

RightShiftLogical.prototype = new ShiftOperation();
RightShiftLogical.prototype.constructor = RightShiftLogical;

/*---------------------------------- Exports ---------------------------------*/

module.exports = new RightShiftLogical();
 ...
 */
RightShiftLogical.prototype.calculate = function(array, n) {
 ...
 * @returns {number[]} the result of the operation
 */
RightShiftLogical.prototype.calculateRange = function(array, n, begin, end) {
