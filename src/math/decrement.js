...
/**
 * This class performs the decrement operation for plate stacks, plates, wells
 ...
 * <br><br>
 *
 * <b>Decrement Operation Example:</b>
 *
 * <br><br>
 *
 * <span style="color: purple;">var</span> decrement = <span style="color: purple;">new</span> Decrement();<br>
 * <span style="color: purple;">var</span> well = <span style="color: purple;">new</span> Well('A1', [1, 2, 3, 4]);<br>
 * decrement.<span style="color: Sienna;">well</span>(well) <span style="color: purple;">  &nbsp=>&nbsp  </span> Well { base: 26, row: 0, column: 1, data: [ 0, 1, 2, 3 ] }
 *
 * <br><br>
 *
...
Decrement.prototype = new UnaryOperation();
Decrement.prototype.constructor = Decrement;

/*---------------------------------- Exports ---------------------------------*/

module.exports = new Decrement();

/*--------------------------- Calculate Functions ----------------------------*/

/**
 * Decrements the values in the array.
 * @param {number[]} array - the input array
 * @returns {number[]} the result of the operation
 */
Decrement.prototype.calculate = function(array) {
...
/**
 * Decrements the values between the indices.
 * @param {number[]} array - the input array
 * @param {number} begin - the beginning index
 * @param {number} end - the ending index
 * @returns {number[]} the result of the operation
 */
Decrement.prototype.calculateRange = function(array, begin, end) {
