 ...
 * <br><br>
 *
 * <b>Left Shift Operation Example:</b>
 *
 * <br><br>
 *
 ...
 * leftShift.<span style="color: Sienna;">well</span>(well, bitNumber) <span style="color: purple;">  &nbsp=>&nbsp  </span> Well { base: 26, row: 0, column: 1, data: [ 4, 8, 12, 16 ] }
 *
 * <br><br>
 *
...
LeftShift.prototype = new ShiftOperation();
LeftShift.prototype.constructor = LeftShift;

/*---------------------------------- Exports ---------------------------------*/

module.exports = new LeftShift();
 ...
 */
LeftShift.prototype.calculate = function(array, n) {
 ...
 * @returns {number[]} the result of the operation
 */
LeftShift.prototype.calculateRange = function(array, n, begin, end) {
