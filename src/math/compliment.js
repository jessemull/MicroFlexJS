 ...
 * <br><br>
 *
 * <b>Compliment Operation Example:</b>
 *
 * <br><br>
 *
 * <span style="color: purple;">var</span> compliment = <span style="color: purple;">new</span> Compliment();<br>
 * <span style="color: purple;">var</span> well = <span style="color: purple;">new</span> Well('A1', [1, -2, 3, -4]);<br>
 * compliment.<span style="color: Sienna;">well</span>(well) <span style="color: purple;">  &nbsp=>&nbsp  </span> Well { base: 26, row: 0, column: 1, data: [ -2, 1, -4, 3 ] }
 *
 * <br><br>
 *
...
Compliment.prototype = new UnaryOperation();
Compliment.prototype.constructor = Compliment;
...
/**
 * Compliments the values in the array.
 * @param {number[]} array - the input array
 * @returns {number[]} the result of the operation
 */
Compliment.prototype.calculate = function(array) {
...
/**
 * Compliments the values between the indices.
 * @param {number[]} array - the input array
 * @param {number} begin - the beginning index
 * @param {number} end - the ending index
 * @returns {number[]} the result of the operation
 */
Compliment.prototype.calculateRange = function(array, begin, end) {
